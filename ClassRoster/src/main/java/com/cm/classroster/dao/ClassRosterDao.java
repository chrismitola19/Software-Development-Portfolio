...
//The ClassRosterDao is pretty straightforward. We'll have one method for each use case.
...
/*Notice that all the methods in the interface are commented with Javadoc comments. 
This not only provides great documentation in the source code but also allows you to run 
the Javadoc tool on your codebase to produce HTML documentation similar to what we looked 
at for Collection, List, and Map.*/